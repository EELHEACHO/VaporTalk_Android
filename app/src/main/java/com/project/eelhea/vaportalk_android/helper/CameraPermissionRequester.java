...
/**
 * Created by eelhea on 2017. 4. 11..
 */
...
public class CameraPermissionRequester {
    ...
    private CameraPermissionRequester(Activity context){
    ...
    public static class Builder {
        private CameraPermissionRequester requester;

        public Builder(Activity context){
            requester = new CameraPermissionRequester(context);
        }
        ...
        public CameraPermissionRequester create(){
